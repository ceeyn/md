...
<img src="/Users/haozhipeng/Library/Application Support/typora-user-images/截屏2023-06-26 下午8.27.47.png" alt="截屏2023-06-26 下午8.27.47" style="zoom:50%;" />
...
<img src="/Users/haozhipeng/Library/Application Support/typora-user-images/截屏2023-06-26 下午10.25.36.png" alt="截屏2023-06-26 下午10.25.36" style="zoom:50%;" />
...
**异质混合**：同质性系数还可以衡量**注释对之间的异质混合程度**。异质混合被定义为具有给定标准化属性分数的节点与具有另一个属性y的相似标准化分数的**节点连接的倾向**。**对于注释x和y对之间的同质性系数**，它被定义为：<img src="/Users/haozhipeng/Library/Application Support/typora-user-images/截屏2023-07-04 下午3.28.37.png" alt="截屏2023-07-04 下午3.28.37" style="zoom:50%;" />

**同质性比率**：为了**量化各个区域与具有类似属性的区域连接程度，我们计算了每个节点的同质性比率**。**这个度量是节点的注释与其相邻节点注释的加权平均差与节点与网络中所有其他节点注释的平均绝对差之间的比率**。具体而言，**给定节点i的注释为x(i)**，同质性比率h(i)被定义为：<img src="/Users/haozhipeng/Library/Application Support/typora-user-images/截屏2023-07-04 下午4.42.26.png" alt="截屏2023-07-04 下午4.42.26" style="zoom:50%;" />

其中n是连接组中节点的数量。

**平均连接距离**：每个节点的平均同质性比率与其平均连接距离进行比较。**平均连接距离定义为节点与其相连的邻居之间的加权平均距离**，其中每个连接的权重为该连接的权重。具体而言，节点i的平均连接距离(MCD)被定义为：

其中**dij表示节点i和节点j之间的欧几里得距离**。<img src="/Users/haozhipeng/Library/Application Support/typora-user-images/截屏2023-07-04 下午4.44.12.png" alt="截屏2023-07-04 下午4.44.12" style="zoom:50%;" />
